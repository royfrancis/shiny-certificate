...
ARG REPO="royfrancis/shiny-certificate"
...
RUN Rscript -e 'install.packages(c("Cairo","curl","ggplot2","ggtext","png","shinythemes","shinyAce","showtext"),dependencies=c("Depends","Imports"))'
